...
"""autogenerated by genpy from custom_msgs/Detections.msg. Do not edit."""
import codecs
import sys
...
class Detections(genpy.Message):
  _md5sum = "81f9cb6999cd28efac836bbb8d43899e"
  _type = "custom_msgs/Detections"
...
string shape                # e.g. "spherical", "conical", "octagonal", "human", "chair-like\""""
  ...
  _slot_types = ['std_msgs/Header','custom_msgs/Detection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = custom_msgs.msg.Detection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.detected_color = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.detected_color = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
